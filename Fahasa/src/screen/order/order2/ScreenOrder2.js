      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.PTVCbox}>
            <Image style={{ width: 40, height: 40, marginHorizontal: 10, marginVertical: 10 }}
              source={require('../../../assets/tick.png')} />
            <View style={styles.PTVCbox2}>
              <Text style={styles.PTVC_Text1}>Giao hàng tiêu chuẩn : 19.000đ</Text>
              <Text style={styles.PTVC_Text2}>Ngày giao hàng: Thứ bảy - 22/7</Text>
            </View>
          </View>
          ...
          <View style={styles.PTTTbox}>
            <View style={styles.checkbox}>
              <CheckBox
                ...
                onValueChange={(newValue) => setToggleCheckBox(newValue)}
              />
              <Image style={{ width: 40, height: 20, marginHorizontal: 10, marginVertical: 10 }}
            ...
            <View style={styles.checkbox}>
              ...
              <Text style={styles.PTTTbox_Text}>Ví Moca trên Ứng dụng Grab</Text>
            </View>
            ...
            <View style={styles.checkbox}>
              ...
              <Text style={styles.PTTTbox_Text}>Thẻ ATM nội địa / Interbanking</Text>
            </View>
            ...
            <View style={styles.checkbox}>
              ...
              <Text style={styles.PTTTbox_Text}>Thanh toán bằng tiền mặt khi nhận hàng</Text>
            </View>
          ...
          <View style={styles.KMbox}>
            ...
            <View>
              ...
              <Text style={styles.KM_Text2}>Có thể áp dụng đồng thời nhiều mã</Text>
            </View>
