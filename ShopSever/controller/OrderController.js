...
const createOrder = async (req, res) => {
    try {
        ...
        const { cart, total, addressId, shippingId, promoCode, } = req.body
        // Gọi service để tạo đơn hàng
        const order = await orderService.createOrder(userId, cart, total, addressId, shippingId, promoCode);
...
const payWithPaypal = async (req, res) => {
    try {
        ...
        const paymentUrl = await orderService.payWithPaypal(userId, products, total, addressId, shippingId, promoCode);
